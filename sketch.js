...
var cutB1, cutB2, balaoB, balaoB2, muteB;
...
function setup() {
  ...
  bunny = createSprite(520, 620, 100, 100);
  bunny.scale = 0.2;
  ...
  Edisplay.addAnimation('2stars', display2);
  Edisplay.changeAnimation('empty');

  Edisplay2 = createSprite(105, 18, 30, 30); 
  Edisplay2.scale = 0.2;
  Edisplay2.addAnimation('empty', displayV);
  Edisplay2.addAnimation('oneStar', display1);
  Edisplay2.addAnimation('2stars', display2);
  Edisplay2.changeAnimation('empty');
  ...
  //criar sprite para star3 e suas características 
  star3 = createSprite(320, 330, 20, 20);
  star3.scale = 0.025;
  star3.addAnimation('star3', starImg);
  ...
  balaoB2 = createImg("balloon.png");
  balaoB2.position(20, 320);
  balaoB2.size(120, 100);
  balaoB2.mouseClicked(airBlow2);
...
function draw() {
  ...
  imageMode(CENTER);
  if (fruit != null) {
    image(fruitImg, fruit.position.x, fruit.position.y, 180, 100);
  }
  pop();
  ...
  if(collide(fruit, star2, 40) == true){
    star2.visible = false;
    Edisplay.changeAnimation('2stars');
    Edisplay2.changeAnimation('oneStar');
  }

  //verificação de colisão com a terceira estrela
  if(collide(fruit, star3, 40) == true){
    star3.visible = false;
    Edisplay2.changeAnimation('2stars');
  }
}
